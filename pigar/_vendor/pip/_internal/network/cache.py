...
from pigar._vendor.pip._vendor.cachecontrol.cache import SeparateBodyBaseCache
from pigar._vendor.pip._vendor.cachecontrol.caches import SeparateBodyFileCache
from pigar._vendor.pip._vendor.requests.models import Response

from pigar._vendor.pip._internal.utils.filesystem import (
    adjacent_tmp_file,

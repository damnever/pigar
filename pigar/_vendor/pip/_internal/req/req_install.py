...
from pigar._vendor.pip._internal.operations.install.legacy import install as install_legacy
...
from pigar._vendor.pip._internal.utils.deprecation import LegacyInstallReason, deprecated
